  ...
  return (
    <section className={`${styles.paddings} relative z-10`}>
      ...
      <motion.div initial="hidden"
        ...
        className={`max-w-[1280px] mt-[50px] mx-auto flex lg:flex-row flex-col gap-6`}>

        <motion.div variants={fadeIn('right', 'tween', 0.2, 1)}
          className="flex-[0.5] lg:max-w-[370px] flex justify-end flex-col gradient-05 sm:p-8 p-4 rounded-[32px] border-[1px] border-gray-400 relative">
